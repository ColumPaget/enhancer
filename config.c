...
static const char *enhancer_parse_config_item(const char *ConfigStr, TEnhancerConfig *Conf, int FuncID)
{
    ...
    while (ptr)
    {
        ...
        case TOK_ALLOW_XSENDEVENT:
            enhancer_set_config(Conf, val, Name, 0, FLAG_ALLOW_XSENDEVENT);
            break;
