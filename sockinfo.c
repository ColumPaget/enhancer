...
{
	case  AF_PACKET : sock_family="raw"; break;
	...
	case  AF_NETLINK  : sock_family="netlink"; break;
	...
	case  AF_IPX  : sock_family="ipx"; break;
	case  AF_X25  : sock_family="x25"; break;
	case  AF_IRDA  : sock_family="irda"; break;
	case  AF_BLUETOOTH  : sock_family="bluetooth"; break;

	default: sock_family="other"; break;
